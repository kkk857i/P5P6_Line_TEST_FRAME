...
class EmailUtils:
    def __init__(self, email_body ,email_attch_path=None):
        ...
        self.sender = "1067270040@qq.com"
        self.password = "yncyyagtvudubcah"
        self.receiver = "1067270040@qq.com,1421899585@qq.com"   #收件人
        self.cc = "329999897@qq.com,1918819041@qq.com"
